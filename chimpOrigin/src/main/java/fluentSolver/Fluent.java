...
public class Fluent extends MultiVariable implements Activity{
	...
	public void setRecName(String name) {
		this.getRectangularRegioInterval().setName(name);
		}
...
//		ret.append("Spatial : ");
//		ret.append(this.getRectangularRegioInterval().getDomain());
//		ret.append(">");
...
//		return "";
	...
	public String[] SetSpatialVariable(String[] a) {
		return spC=a;
	}
	
	public RectangularRegion getRectangularRegioInterval() {

	//	System.out.println("Internal Variables " + this.getInternalVariables()[2].toString());
		return (RectangularRegion) this.getInternalVariables()[2];
	}
