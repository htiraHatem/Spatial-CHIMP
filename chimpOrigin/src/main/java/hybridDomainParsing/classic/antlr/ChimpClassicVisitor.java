...
public interface ChimpClassicVisitor<T> extends ParseTreeVisitor<T> {
	...
	T visitSpatial_constraint1_op_element(Spatial_constraint1_defContext ctx);

	T visitSpatial_constraint2_op_element(Spatial_constraint2_defContext ctx);

	Object visitSpatial_constraint_def(Spatial_constraint_defContext ctx);

	Object visitSpatial_constraint_op_element(Spatial_constraint_op_elementContext ctx);

	Object visitDeleteSpatial_constraint_op_element(Delete_spatial_constraint_op_elementContext ctx);
