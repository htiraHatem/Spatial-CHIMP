...
public class ChimpClassicReader implements ChimpClassicVisitor {
    ...
    @Override
    public Object visitSpatial_constraint_op_element(ChimpClassicParser.Spatial_constraint_op_elementContext ctx) {
        return   visitSpatial_constraint_def(ctx.spatial_constraint_def());
    }
    
    @Override
    public Object visitDeleteSpatial_constraint_op_element(ChimpClassicParser.Delete_spatial_constraint_op_elementContext ctx) {
        return   visitDeleteSpatial_constraint_def(ctx.delete_spatial_constraint_def());
    }
...
//        }
    ...
    private Object visitDeleteSpatial_constraint_def(
    		Delete_spatial_constraint_defContext ctx) {
        if(ctx.delete_spatial_constraint1_def() != null) {
            return  visitDeleteSpatial_constraint1_op_element(ctx.delete_spatial_constraint1_def());
        } else {
            return  visitDeleteSpatial_constraint2_op_element((ctx.delete_spatial_constraint2_def()));
        }
    }
    
    @Override
    public SpatialConstraintTemplate visitDeleteSpatial_constraint1_op_element(ChimpClassicParser.Delete_spatial_constraint1_defContext ctx) {

    		String v0 = ctx.VAR_NAME().getText();
    		UnaryRectangleConstraint.Type constraintType =
    	                visitUnary_spatial_constraint_type(ctx.unary_spatial_constraint_type());
    		String[] varkeys= new String[] {v0};
    		return new SpatialConstraintTemplate(varkeys,constraintType);
    }
    
    private UnaryRectangleConstraint.Type visitUnary_spatial_constraint_type(
			Unary_spatial_constraint_typeContext unary_spatial_constraint_type) {
        return UnaryRectangleConstraint.Type.valueOf(unary_spatial_constraint_type.getText());

	}

	@Override
    public SpatialConstraintTemplate visitDeleteSpatial_constraint2_op_element(ChimpClassicParser.Delete_spatial_constraint2_defContext ctx) {
		...
		return new SpatialConstraintTemplate(varKeys, null, null);
    }
    
    @Override
    public Object visitSpatial_constraint_def(ChimpClassicParser.Spatial_constraint_defContext ctx) {
        if(ctx.spatial_constraint1_def() != null) {
            return (SpatialConstraintTemplate) visitSpatial_constraint1_op_element(ctx.spatial_constraint1_def());
        } else {
            return  visitSpatial_constraint2_op_element((ctx.spatial_constraint2_def()));
        }
    }
    
    @Override
    public SpatialConstraintTemplate visitSpatial_constraint1_op_element(ChimpClassicParser.Spatial_constraint1_defContext ctx) {

    		String v0 = ctx.VAR_NAME(0).getText();
            String v1 = ctx.VAR_NAME(1).getText();
            String[] varKeys = new String[] {v0, v1};

            AllenIntervalConstraint.Type constraintType1 =
                    visitBinary_temporal_constraint_type(ctx.binary_temporal_constraint_type(0));
            AllenIntervalConstraint.Type constraintType2 =
                    visitBinary_temporal_constraint_type(ctx.binary_temporal_constraint_type(1));

    		return new SpatialConstraintTemplate(varKeys,constraintType1,constraintType2);
    }
    
    @Override
    public SpatialConstraintTemplate visitSpatial_constraint2_op_element(ChimpClassicParser.Spatial_constraint2_defContext ctx) {
    	String v0 = ctx.VAR_NAME(0).getText();
        String v1 = ctx.VAR_NAME(1).getText();
        ...
        return new SpatialConstraintTemplate(varKeys, cste, op2, op1);
