...
//		String[][] symbols = TestSpatialRACEDomain.createSymbols();
//		int[] ingredients = TestSpatialRACEDomain.createIngredients();
//		
//		planner = new HTNPlanner(0,  600,  0, symbols, ingredients);
//		fluentSolver = (FluentNetworkSolver)planner.getConstraintSolvers()[0];
//		
////		initMetaConstraints();
//		TestSpatialRACEDomain.initPlanner(planner, "domains/race_domain.ddl");
